# Playing-Card-Detection---YOLO-V4-
Detect playing cards using yolo v4. And Deploy it in android.

![result](https://user-images.githubusercontent.com/39921122/116121122-20520d00-a6e2-11eb-9f20-077bb5292787.png)
...
# If you have a custom model then replace the (.name) file in the ./data/classes/ and replace the (.weight) file in ./data 
# Then you need to edit the "./data/classes/coco.names" coco.names name with your own custom (.names). You will find in the config.py file which is in ./core/ folder.
